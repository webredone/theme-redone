...
final class Template_19bee69fe3 extends LR\Template
{
    ...
    <nav class="navbar">
      ...
      ';
        echo LR\Filters::escapeHtmlText(wp_nav_menu(['menu' => 'top', 'theme_location' => 'menu-1', 'container' => 'div', 'container_id' => 'tr-main-menu', 'container_class' => 'navbar-collapse', 'menu_id' => 'primary-menu', 'menu_class' => 'navbar-nav', 'depth' => 2, 'fallback_cb' => 'ThemeRedoneWalker::fallback', 'walker' => new ThemeRedone\Features\ThemeRedoneWalker()])) /* line 23 */;
        echo '
    </nav>
  </div></header>
';
