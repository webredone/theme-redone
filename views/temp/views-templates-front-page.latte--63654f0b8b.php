...
final class Template63654f0b8b extends Latte\Runtime\Template
{
...
';
		$test_arr = ["href" => "https://google.com", "target" => false, "title" => "Yooo"];
		echo '<lit-button obj=\'';
		echo LR\Filters::escapeHtmlAttr(($this->global->fn->tr_j)($test_arr)) /* line 12 */;
		echo '\'></lit-button>
...
<section class="content">
	<div class="container">
		';
		echo LR\Filters::escapeHtmlText(the_content()) /* line 17 */;
		echo '
	</div>
</section>
	...
	<div class="container">
		...
		<div class="g-row row--3 col--centered">
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('svg-1')) /* line 336 */;
		echo '
					<h5>SVG Icon 1</h5>
					<p>
			...
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('svg-2')) /* line 345 */;
		echo '
					<h5>SVG Icon 2</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
			...
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('svg-3')) /* line 354 */;
		echo '
					<h5>SVG Icon 3</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
	...
	<div class="container">
		...
		<div class="g-row row--3 col--centered">
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true)) /* line 373 */;
		echo '
					<h5>SVG Icon 1</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
			...
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true)) /* line 382 */;
		echo '
					<h5>SVG Icon 2</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
			...
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true)) /* line 391 */;
		echo '
					<h5>SVG Icon 3</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
	...
	<div class="container">
		...
		<div class="g-row row--3 col--centered">
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true, true)) /* line 410 */;
		echo '
					<h5>SVG Icon 1</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
			...
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true, true)) /* line 419 */;
		echo '
					<h5>SVG Icon 2</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
			...
			<div class="col">
				<div >
					';
		echo LR\Filters::escapeHtmlText(($this->global->fn->tr_latte_get_svg)('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true, true)) /* line 428 */;
		echo '
					<h5>SVG Icon 3</h5>
					<p>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur repellendus ea, blanditiis error culpa commodi.
...
<section>
	<div class="container">
		...
		<div
			...
			data-img-src="';
		echo LR\Filters::escapeHtmlAttr(($this->global->fn->tr_latte_get_img_path)('people/photo-1517299151253-d0449b733f57.jpg')) /* line 492 */;
		echo '"
		>
		</div>						
	</div>
