...
final class Templateb5b2b437f7 extends Latte\Runtime\Template
{
		...
		echo '" alt="yo">
			...
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<br><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('svg-1.svg', true)) /* line 296 */;
		echo '
				</div>
			</div>
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<br><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-1.svg')) /* line 303 */;
		echo '
				</div>
			</div>
			...
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<br><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-1.svg', true)) /* line 311 */;
		echo '
				</div>
			</div>
		</div>
