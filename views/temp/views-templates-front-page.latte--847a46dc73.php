...
final class Template847a46dc73 extends Latte\Runtime\Template
{
		...
		<div class="f-row" style="--i-cols: 3; --i-gap: 30">
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<br><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_svg('svg-1')) /* line 276 */;
		echo '
					';
		echo LR\Filters::escapeHtmlText(tr_get_svg('svg-1')) /* line 277 */;
		echo '
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('svg-1.svg')) /* line 278 */;
		echo '
				</div>
			</div>
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<br><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_svg('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true)) /* line 285 */;
		echo '
				</div>
			</div>
			...
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<br><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_svg('http://localhost/wrwp-starter/wp-content/uploads/2021/01/svg-3.svg', true, true)) /* line 293 */;
		echo '
				</div>
			</div>
		</div>
		...
		<div class="f-row" style="--i-cols: 3; --i-gap: 30">
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<h5>No ALT</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('people/photo-1517299151253-d0449b733f57.jpg', false)) /* line 311 */;
		echo '

					<br><br>
					<h5>Don\'t Print (Only useful for debugging and showing how it will look like for some reason)</h5><br>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('people/photo-1517299151253-d0449b733f57.jpg', true, true)) /* line 315 */;
		echo '

					<br><br>
					<h5>With ALT</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media(['src' => 'people/photo-1517299151253-d0449b733f57.jpg', 'alt' => 'manually added alt text'], false)) /* line 319 */;
		echo '
				</div>
			</div>
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<h5>No ALT String</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('people/photo-1517299151253-d0449b733f57.jpg', true)) /* line 328 */;
		echo '

					<h5>No ALT Array</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media(['src' => 'people/photo-1517299151253-d0449b733f57.jpg'], true)) /* line 331 */;
		echo '

					<h5>With manually wrritten ALT Array</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media(['src' => 'people/photo-1517299151253-d0449b733f57.jpg', 'alt' => 'manually added alt text'], true)) /* line 334 */;
		echo '
				</div>
			</div>
			...
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<div
						...
						data-img-src="';
		echo LR\Filters::escapeHtmlAttr(tr_get_media_path('people/photo-1517299151253-d0449b733f57.jpg')) /* line 346 */;
		echo '"
					>
					</div>
					<br><br>
					...
					<br><br>
					<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl(tr_get_media_path('people/photo-1517299151253-d0449b733f57.jpg'))) /* line 352 */;
		echo '">
				</div>
			</div>
		</div>
...
';
		...
		foreach ($btn_vars as $btn_var) {
			...
			echo LR\Filters::escapeHtmlAttr($btn_var) /* line 372 */;
			echo '">Btn ';
			echo LR\Filters::escapeHtmlText($btn_var) /* line 372 */;
			echo '</a>
';
			$iterations++;
		}
...
';
	...
	public function prepare(): void
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === "extends") {
			foreach (array_intersect_key(['key' => '249', 'value' => '249', 'btn_var' => '372'], $this->params) as $ʟ_v => $ʟ_l) {
