...
final class Templatee1b0b35107 extends Latte\Runtime\Template
{
			...
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<div
						...
						data-img-src="';
		echo LR\Filters::escapeHtmlAttr(($this->global->fn->tr_latte_get_img_path)('people/photo-1517299151253-d0449b733f57.jpg')) /* line 334 */;
		echo '"
					>
					</div>
				</div>
...
';
		...
		foreach ($btn_vars as $btn_var) {
			...
			echo LR\Filters::escapeHtmlAttr($btn_var) /* line 356 */;
			echo '">Btn ';
			echo LR\Filters::escapeHtmlText($btn_var) /* line 356 */;
			echo '</a>
';
			$iterations++;
		}
...
';
	...
	public function prepare(): void
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === "extends") {
			foreach (array_intersect_key(['key' => '249', 'value' => '249', 'btn_var' => '356'], $this->params) as $ʟ_v => $ʟ_l) {
