...
final class Templatea63ff8a0a3 extends Latte\Runtime\Template
{
...
';
		...
		foreach ($tabs as $key => $value) {
			...
			echo LR\Filters::escapeHtmlAttr($key == 0 ? 'activeTab' : '') /* line 195 */;
			echo '" data-href="panel-';
			echo LR\Filters::escapeHtmlAttr($key) /* line 195 */;
			echo '">
              ';
			echo LR\Filters::escapeHtmlText($value) /* line 196 */;
			echo '
            </button>
';
			$iterations++;
...
';
		...
		foreach ($tabs as $ckey => $cvalue) {
			...
			echo LR\Filters::escapeHtmlAttr($ckey == 0 ? 'activeTab enter' : '') /* line 204 */;
			echo '" data-id="panel-';
			echo LR\Filters::escapeHtmlAttr($ckey) /* line 204 */;
			echo '">
			...
			echo ' Content Lorem Ipsum dolor sit amet</h4> 
								...
								<p>content panel - ';
			echo LR\Filters::escapeHtmlText($cvalue) /* line 208 */;
			echo '</p> 
...
';
		...
		foreach ($acc_items as $key => $acc_item) {
			...
			echo LR\Filters::escapeHtmlAttr($key == 0 ? 'active' : '') /* line 236 */;
			echo '">
            <button type="button" class="accordion-item__btn btn-link">
              ';
			echo LR\Filters::escapeHtmlText($acc_item) /* line 238 */;
			echo '
            </button> 
            <div 
...
';
		...
		foreach ($acc_items as $key => $acc_item) {
			echo '          <div class="accordion-item ';
			echo LR\Filters::escapeHtmlAttr($key == 0 ? 'active' : '') /* line 260 */;
			echo '">
            <button type="button" class="accordion-item__btn btn-link">
              ';
			echo LR\Filters::escapeHtmlText($acc_item) /* line 262 */;
			echo '
            </button> 
            <div 
              class="accordion-item__body"
...
';
	...
	<section>
		<div class="container">
			...
			';
		echo LR\Filters::escapeHtmlText(tr_modal_start('modal-example', 'Modal Title here', 'modal-additional-class')) /* line 287 */;
		echo '
				<h3>Modal</h3>
				<p>
			...
			';
		echo LR\Filters::escapeHtmlText(tr_modal_end()) /* line 297 */;
		echo '
	...
	<section>
		<div class="container">
			...
			';
		echo LR\Filters::escapeHtmlText(tr_get_component('latest-blog-posts')) /* line 313 */;
		echo '
		</div>
	</section>
...
';
	...
	public function prepare(): void
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === "extends") {
			foreach (array_intersect_key(['key' => '194, 235, 259', 'value' => '194', 'ckey' => '203', 'cvalue' => '203', 'acc_item' => '235, 259'], $this->params) as $ʟ_v => $ʟ_l) {
