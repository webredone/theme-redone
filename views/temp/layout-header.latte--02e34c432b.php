...
final class Template02e34c432b extends Latte\Runtime\Template
{
...
<head>
	...
	<style id="critical-css" type="text/css">
		';
		echo file_get_contents(get_template_directory() . '/prod/critical.css') /* line 18 */;
		echo '
	</style>
...
<body ';
		echo LR\Filters::escapeHtmlAttrUnquoted(body_class()) /* line 30 */;
		echo '>
';
		/* line 31 */
