...
final class Templatef1af86c3e1 extends Latte\Runtime\Template
{
		...
		<div class="f-row" style="--i-cols: 3; --i-gap: 30">
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<h5>No ALT</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media('people/photo-1517299151253-d0449b733f57.jpg', false, false)) /* line 309 */;
		echo '
					<h5>With ALT</h5>
					';
		echo LR\Filters::escapeHtmlText(tr_get_media(['src' => 'people/photo-1517299151253-d0449b733f57.jpg', 'alt' => 'manually added alt text'], false, false)) /* line 311 */;
		echo '
					';
		echo LR\Filters::escapeHtmlText(tr_get_media(['src' => 'people/photo-1517299151253-d0449b733f57.jpg', 'alt' => 'manually added alt text'], false, true)) /* line 312 */;
		echo '
				</div>
			</div>
			<div class="col" style="box-shadow: 0 0 0 1px red;">
			...
			<div class="col" style="box-shadow: 0 0 0 1px red;">
				<div  style="padding: 20px">
					...
					<div
						...
						data-img-src="';
		echo LR\Filters::escapeHtmlAttr(($this->global->fn->tr_latte_get_img_path)('people/photo-1517299151253-d0449b733f57.jpg')) /* line 339 */;
		echo '"
					>
					</div>
				</div>
...
';
		...
		foreach ($btn_vars as $btn_var) {
			...
			echo LR\Filters::escapeHtmlAttr($btn_var) /* line 361 */;
			echo '">Btn ';
			echo LR\Filters::escapeHtmlText($btn_var) /* line 361 */;
			echo '</a>
';
			$iterations++;
		}
...
';
	...
	public function prepare(): void
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === "extends") {
			foreach (array_intersect_key(['key' => '249', 'value' => '249', 'btn_var' => '361'], $this->params) as $ʟ_v => $ʟ_l) {
