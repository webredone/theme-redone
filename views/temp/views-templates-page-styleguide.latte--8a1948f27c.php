...
final class Template8a1948f27c extends Latte\Runtime\Template
{
...
';
		...
		foreach ($tabs as $key => $value) {
			...
			echo LR\Filters::escapeHtmlAttr($key == 0 ? 'activeTab' : '') /* line 147 */;
			echo '" data-href="panel-';
			echo LR\Filters::escapeHtmlAttr($key) /* line 147 */;
			echo '">
										';
			echo LR\Filters::escapeHtmlText($value) /* line 148 */;
			echo '
									</button>
';
			$iterations++;
...
';
		...
		foreach ($tabs as $ckey => $cvalue) {
			...
			echo LR\Filters::escapeHtmlAttr($ckey == 0 ? 'activeTab enter' : '') /* line 156 */;
			echo '" data-id="panel-';
			echo LR\Filters::escapeHtmlAttr($ckey) /* line 156 */;
			echo '">
										<div class="tab-panel__content">
											<h4>';
			echo LR\Filters::escapeHtmlText($cvalue) /* line 158 */;
			echo ' Content Lorem Ipsum dolor sit amet</h4> 
											<img src="https://source.unsplash.com/1200x400" alt="">
											<p>content panel - ';
			echo LR\Filters::escapeHtmlText($cvalue) /* line 160 */;
			echo '</p> 
...
';
		...
		foreach ($acc_items as $key => $acc_item) {
			...
			echo LR\Filters::escapeHtmlAttr($key == 0 ? 'active' : '') /* line 176 */;
			echo '">
									<button type="button" class="accordion-item__btn btn-link">
										';
			echo LR\Filters::escapeHtmlText($acc_item) /* line 178 */;
			echo '
									</button> 
									<div 
...
';
	...
	<section>
		<div class="container">
			...
			';
		echo LR\Filters::escapeHtmlText(tr_modal_start('modal-example', 'Modal Title here', 'modal-additional-class')) /* line 211 */;
		echo '
				<h3>Modal</h3>
				<p>
			...
			';
		echo LR\Filters::escapeHtmlText(tr_modal_end()) /* line 221 */;
		echo '
...
';
	...
	public function prepare(): void
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === "extends") {
			foreach (array_intersect_key(['item' => '96', 'key' => '146, 175', 'value' => '146', 'ckey' => '155', 'cvalue' => '155', 'acc_item' => '175'], $this->params) as $ʟ_v => $ʟ_l) {
