...
final class Template50ca19ab60 extends Latte\Runtime\Template
{
	...
	public function main(): array
	{
		...
		echo "\n";
		/* line 11 */
		$this->createTemplate(($this->global->fn->tr_view_path)('/partials/todo-remove-examples'), $this->params, 'include')->renderToContentType('html');
		echo '
