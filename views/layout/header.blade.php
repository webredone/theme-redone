...
<head>
    ...
    <style id="critical-css" type="text/css">
        {!! file_get_contents(get_template_directory() . '/dist/global/critical.css') !!}
    </style>

    <link rel="preload" href="{{ get_template_directory_uri() }}/dist/global/style.css" as="style">
    <link rel="stylesheet" href="{{ get_template_directory_uri() }}/dist/global/style.css">

    <script type="text/javascript">
        var tr_theme_url = "{{ get_bloginfo('template_url') }}";
        var tr_site_url = "{{ esc_url(home_url('/')) }}";
    </script>
</head>

<body {!! body_class() !!}>
    @include(tr_view_path('layout/main-menu'))
